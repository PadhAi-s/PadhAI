      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:py-10">
        ...
        <section className="mt-5 grid gap-5 md:grid-cols-2">
          {filteredWords.map((item) => (
            <article
              key={item.word}
              className="group rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-slate-800 dark:bg-slate-900"
            >
